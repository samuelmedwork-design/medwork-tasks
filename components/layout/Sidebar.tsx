...
export default function Sidebar({ currentUser }: SidebarProps) {
  ...
  return (
    <aside className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col h-full fixed left-0 top-0 bottom-0">
      {/* Logo */}
      <div className="flex flex-col items-center px-6 py-5 border-b border-slate-700 gap-1">
        <Image src="/logo.png" alt="MedWork" width={140} height={48} className="object-contain" priority />
        <span className="text-xs text-slate-500 tracking-widest font-medium uppercase">Tasks</span>
      </div>
