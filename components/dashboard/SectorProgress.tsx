        ...
        <div key={sector.id}>
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-slate-700 dark:text-slate-300">{sector.icon} {sector.name}</span>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-slate-600 dark:text-slate-400 w-9 text-right">{percentage}%</span>
          </div>
        </div>
      ))}
    </div>
